...
SystemUtil.Run "C:\Program Files\Google\Chrome\Application\chrome.exe","--profile-directory=Default","","Open"
Browser("Google").Navigate Parameter("URL")
Reporter.ReportEvent micPass,"Advantage Online Shopping ","The AOS site is open"
